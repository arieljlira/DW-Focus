...
class dw_focus_categories_Widget extends WP_Widget {
    ...
    ?>
        ...
        <div class="meta-info">
            ...
            <p> --
                <label for="<?php echo $this->get_field_id('date'); ?>" ><input type="checkbox" <?php disabled( false,  $instance['meta'] ); ?> name="<?php echo $this->get_field_name('date') ?>" id="<?php echo $this->get_field_id('date'); ?>" <?php checked(true, $date); ?> class="submeta-info" >&nbsp;&nbsp;<?php  _e('Show the date of post','dw-focus') ?> </label>
            </p>
            <p> --
                <label for="<?php echo $this->get_field_id('author'); ?>" ><input type="checkbox" <?php disabled( false, $instance['meta'] ); ?> name="<?php echo $this->get_field_name('author') ?>" id="<?php echo $this->get_field_id('author'); ?>" <?php checked(true, $author); ?> class="submeta-info" >&nbsp;&nbsp;<?php  _e('Show the author info','dw-focus') ?> </label>
            </p>
            <p> --
                <label for="<?php echo $this->get_field_id('cat'); ?>" ><input type="checkbox" <?php disabled( false,  $instance['meta'] ); ?> name="<?php echo $this->get_field_name('cat') ?>" id="<?php echo $this->get_field_id('cat'); ?>" <?php checked(true, $cat); ?> class="submeta-info" >&nbsp;&nbsp;<?php  _e('Show the category info','dw-focus') ?> </label>
            </p>
        </div>
            ...
            <div class="span6">
                <article <?php post_class($post_class); ?>>
                    ...
                    <?php if( isset( $instance['meta'] ) && $instance['meta'] ) { ?>
                        ...
                        <?php 
                            if(  ( isset( $instance['author'] ) && $instance['author'] && isset( $instance['date'] ) && $instance['date'] ) || ( isset( $instance['author'] ) && $instance['author'] && isset( $instance['cat'] ) && $instance['cat'] ) ) {
                                _e(' - ','dw-focus');
                            }
                        ?>
                        ...
                        <?php 
                            if( isset( $instance['date'] ) && $instance['date'] ) {
                                echo '<span>'.dw_human_time().'</span>'; 
                            }
                        ?>

                        <?php 
                            if( isset( $instance['date'] ) && $instance['date'] && isset( $instance['cat'] ) && $instance['cat'] ) {
                                _e(' - ','dw-focus');
                            }
                        ?>
